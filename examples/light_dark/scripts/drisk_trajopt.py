...
from score_po.policy_optimizer import (
    DRiskPolicyOptimizerParams,
    DRiskPolicyOptimizer)
...
@hydra.main(config_path="../config", config_name="drisk_trajopt")
def main(cfg: DictConfig):
    # 1. Set up parameters.
    params = DRiskPolicyOptimizerParams()
    ...
    policy = TimeVaryingOpenLoopPolicy(2, 2, cfg.policy.T)
    ...
    print(os.getcwd())
    sf.load_network_parameters(os.path.join(
    ...
    # 6. Run the optimizer.
    optimizer = DRiskPolicyOptimizer(params)
    optimizer.iterate()
